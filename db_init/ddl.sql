...
ADD COLUMN IF NOT EXISTS profile_date TIMESTAMPTZ,
ADD COLUMN IF NOT EXISTS lat DOUBLE PRECISION,
ADD COLUMN IF NOT EXISTS lon DOUBLE PRECISION,
ADD COLUMN IF NOT EXISTS geom GEOGRAPHY(Point, 4326),
ADD COLUMN IF NOT EXISTS n_levels INTEGER,
ADD COLUMN IF NOT EXISTS min_pres DOUBLE PRECISION,
ADD COLUMN IF NOT EXISTS max_pres DOUBLE PRECISION,
ADD COLUMN IF NOT EXISTS qc_summary JSONB,
ADD COLUMN IF NOT EXISTS summary_text TEXT,
ADD COLUMN IF NOT EXISTS parquet_path TEXT,
